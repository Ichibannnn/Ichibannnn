...
<div align="center">
  ...
  <p>
    Building scalable, responsive web apps &nbsp;·&nbsp; Real-time systems with SignalR
  </p>
  <br/>
...
**Stack:** React · Axios · Charka UI

**Roles:**
| Role | Responsibility |
|---|---|
| `Requestor` | Submits material requests and tracks order status |
| `Approver` | Reviews, validates, and approves/rejects requests |
